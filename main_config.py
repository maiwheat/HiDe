...
if __name__ == "__main__":
    ...
    parser.add_argument('--agent', dest='agent', default='Dkfd', type=str,
                        choices=['SFT', 'Offline','Dkfd'
                                 'LwF', 'EWC', 'SI', 'MAS', 'DT2W','TFusion',
    ...
    parser.add_argument('--energy_ratio', dest='energy_ratio', default=0.5, type=str)
    parser.add_argument('--ratio', dest='ratio', default=10, type=str)
    ...
    parser.add_argument('--data', dest='data', default='har', type=str,
    ...
    # Classifier
    parser.add_argument('--head', dest='head', default='SplitWeightNormLinear', type=str,
                        choices=['Linear', 'CosineLinear', 'SplitCosineLinear','SplitWeightNormLinear'])
    ...
    # Normalizaton layers
    parser.add_argument('--norm', dest='norm', default='LN', type=str,
                        choices=['BN', 'LN', 'IN', 'BIN', 'SwitchNorm', 'StochNorm'])

    parser.add_argument('--input_norm', dest='input_norm', default='LN', type=str,
    ...
    parser.add_argument('--lambda_kd_fmap_freq', dest='lambda_kd_fmap_freq', default=0.1, type=float)
    parser.add_argument('--lambda_kd_fmap', dest='lambda_kd_fmap', default=1e-3, type=float,
                        help='lambda for KD loss on feature map')
    parser.add_argument('--fmap_kd_metric', dest='fmap_kd_metric', default="dtw", type=str,
                        choices=['dtw', 'euclidean', 'pod_temporal', 'pod_variate', 'dilate'],
    ...
    parser.add_argument('--lambda_shared', dest='lambda_shared', default=1, type=float,
                        help='lambda for lambda_shared, no implementing this technique if lambda=0')
    parser.add_argument('--adaptive_weight',  type=boolean_string, default=True,
