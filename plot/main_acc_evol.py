...
if __name__ == '__main__':
    ...
    plot_avg_acc_curves(['UWave', 'UCI-HAR', 'CharTraj', 'EMG', 'DSA', 'GRABMyo', 'WISDM'], norm='BN', separate=False)
    plot_avg_acc_curves(['UWave', 'UCI-HAR', 'CharTraj', 'EMG', 'DSA', 'GRABMyo', 'WISDM'], norm='LN', separate=False)