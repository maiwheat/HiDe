...
data_path = {
    ...
    'charactertrajectories': content_root + '/data/saved/CharacterTrajectories/',
    'wisdm': content_root + '/data/saved/WISDM/',
    'emg': content_root + '/data/saved/EMG_Final/',
